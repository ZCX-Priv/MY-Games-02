	...
	create: function(){
		...
		*/
		...
		function onPlayClick(){
			...
			if(window.famobi.localStorage.getItem("tutorial") === null) {
				onHelpClick(true);
				return;
			}
		...
		function onHelpClick(isTutorialForced){

			//menuInfo.helpPanel.visible = true;
			projectInfo.isTutorialForced = isTutorialForced === true;
			projectInfo.tutorial = true;
			projectInfo.mode = 2;
			projectInfo.clickedHelpButton = isTutorialForced !== true;
			game.state.start('play');
