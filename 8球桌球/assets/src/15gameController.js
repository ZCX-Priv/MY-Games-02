playState.update = function(){
	...
	function exitTutorial(){
		...
		if(projectInfo.clickedHelpButton){
			...
			if(projectInfo.isTutorialForced) {
				window.famobi.localStorage.setItem("tutorial", true);
	...
	function runTutorial(){
		...
		if(game.input.activePointer.isDown && projectInfo.tutorial == true && !projectInfo.isTutorialForced){
